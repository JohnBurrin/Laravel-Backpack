...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('operators') }}'><i class='nav-icon la la-question'></i> Operators</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('machines') }}'><i class='nav-icon la la-question'></i> Machines</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('base_rolls') }}'><i class='nav-icon la la-question'></i> Base_rolls</a></li>
